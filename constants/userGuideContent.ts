...
Bienvenue dans l'univers de **Studeo**, votre plateforme d'apprentissage intelligente propulsée par l'Intelligence Artificielle.

---

## 🧭 Navigation Rapide

1. [Configuration & IA](#configuration-ia)
...
- **Google Gemini** ⭐ : Recommandé (gratuit, rapide, multimodal)
- **OpenAI (GPT-4o)** : Standard industrie
- **Anthropic (Claude 3.5)** : Excellent pour l'écriture
- **Mistral AI** : Alternative européenne
- **IA Locale** : 100% privé, hors ligne
...
### 🏛️ Culture & Humanités (7 profs)
Culture générale, Histoire, Géographie, Littérature, Philosophie, Art, Droit

### 🔬 Sciences (6 profs)
Sciences générales, Biologie, Physique, Chimie, Mathématiques, Astrophysique

### 🎨 Arts & Création (4 profs)
...
1. **💬 Discuter** : Conversation en temps réel
2. **⚡ Quiz** : Génération de QCM spécialisés
3. **📚 Cours & Programmes** : Programmes d'apprentissage complets
...
## Modes de Quiz & Apprentissage

### 🎯 Modes de Quiz

- **Classique** : Auto-évaluation
- **QCM** : Choix multiples avec distracteurs
- **Trous (Cloze)** : Compléter les blancs
- **Dictée** : Écrire ce qui est lu

### 🎮 Modes de Jeu

- **Normal** : Quiz standard
- **Contre-la-montre** : Chronomètre
- **Survie** : Zéro erreur autorisée
