...
export const en: typeof fr = {
    ...
    home: {
        ...
        features: {
            ...
            quiz: {
                ...
                description: "Create custom quizzes in multiple languages"
            },
            conjugator: {
            ...
            library: {
                title: "Quiz Library",
                description: "{setsCount} Quiz, {cardsCount} cards total"
            }
        },
    },
    header: {
    ...
    curriculum: {
        title: "My Lessons & Programs",
        subtitle: "Tailored programs generated by your AI mentors",
        tabs: {
            programs: "Programs",
            lessons: "Lessons",
    ...
    lab: {
        ...
        chat: {
            placeholder: "Press the mic (or Space) to speak.",
            inputPlaceholder: "Press the mic (or Space) to speak.",
            edit: "Edit text",
            processing: "Thinking...",
